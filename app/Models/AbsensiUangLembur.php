...
class AbsensiUangLembur extends Model
{
    use HasFactory;
    ...
    public function scopeRekap($data, $kdsatker, $thn, $bln)
    {
        ...
        return $data->where('kdsatker', $kdsatker)->whereYear('tanggal', $thn)->whereMonth('tanggal', $bln)->groupBy(['nip', 'nama'])->selectRaw('nip, nama, SUM(CASE WHEN jenishari = "kerja" THEN jumlahjam ELSE 0 END) as jumlahjamkerja, SUM(CASE WHEN jenishari = "libur" THEN jumlahjam ELSE 0 END) as jumlahjamlibur');
    }
