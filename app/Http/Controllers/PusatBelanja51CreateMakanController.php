...
class PusatBelanja51CreateMakanController extends Controller
{
    public function index($thn = null)
    {
        ...
        $bulan = AbsensiUangMakan::RekapBulananPusat(auth()->user()->kdsatker, auth()->user()->kdunit, $thn)->get();
        return view('belanja-51-pusat.uang_makan.create.index', [
            'bulan' => $bulan,
            'tahun' => $tahun,
            'thn' => $thn,
    ...
    public function preview($thn, $bln)
    {
        ...
        $data = AbsensiUangMakan::rekapPusat(auth()->user()->kdsatker, auth()->user()->kdunit, $thn, $bln)->get();
        ...
        return view('belanja-51-pusat.uang_makan.create.preview', [
            'data' => $data,
            'thn' => $thn,
            'bln' => $bln,
            'approval' => $aprSatker,
    ...
    public function store($thn, $bln, Request $request)
    {
        ...
        $html2pdf->writeHTML(view('belanja-51-pusat.uang_makan.document.permohonan', [
        ...
        $html2pdf->writeHTML(view('belanja-51-pusat.uang_makan.document.lampiran', [
            'data' => $dataAbsensi,
        ...
        return redirect('/belanja-51-pusat/uang-makan/permohonan/')->with('berhasil', 'permohonan berhasil dibuat');
    }
}
