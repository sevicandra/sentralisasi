            ...
            <div class="overflow-x-auto overflow-y-auto h-full w-full">
                <form action="" method="post" autocomplete="off">
                    ...
                    <div class="flex flex-col gap-2 w-full max-w-2xl">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 p-2 gap-2">
                            <x-input type="text" name="eselon1" value="{{ old('eselon1', $data->eselon1) }}" size="w-full"
                                label="Eselon 1:" />
                            <x-input type="text" name="eselon2" size="w-full" value="{{ old('eselon2', $data->eselon2) }}"
                                label="Eselon 2:" />
                            <x-input type="text" name="eselon3" size="w-full" value="{{ old('eselon3', $data->eselon3) }}"
                                label="Eselon 3:" />
                        </div>
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 p-2 gap-2">
                            <x-input.text name="alamat" value="{{ old('alamat', $data->alamat) }}" size="w-full col-span-1 md:col-span-2 lg:col-span-3"
                                label="Alamat:" />
                        </div>
