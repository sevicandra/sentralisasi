              ...
              <div class="card">
                <form action="" method="post">
                  ...
                  <div class=" card-body">
                    ...
                    <div>
                      @if ($thn && $bln)
                        <a href="{{ config('app.url') }}/belanja-51/dokumen-uang-makan/rekap?thn={{ $thn }}&bln={{ $bln }}" class="btn btn-outline-secondary @if ($item === $bln) active @endif mb-3 mr-1">Download Rekap</a>
                      @endif
                    </div>
