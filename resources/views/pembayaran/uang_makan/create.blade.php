                    ...
                    <div class="flex flex-col gap-2 w-full max-w-2xl">
                        <div class="flex flex-col">
                            <div class="flex flex-col md:flex-row md:gap-2 p-2">
                                ...
                                <x-input name="jmlpegawai" value="{{ old('jmlpegawai') }}" label="Jumlah Pegawai:"
                                    size="w-full" />
                            </div>
                            <div class="flex flex-col md:flex-row md:gap-2 p-2">
                                <x-input.file name="file" value="{{ old('file') }}" label="File Pdf:" size="w-full"
                            ...
                            <div class="flex flex-col md:flex-row md:gap-2 p-2">
                                <x-input name="keterangan" value="{{ old('keterangan') }}" label="Keterangan:"
                                    size="w-full" />
                            </div>
                        </div>
                        <div class="flex gap-2 p-2">
                            <a href="/belanja-51/uang-makan/index" class="btn btn-xs btn-secondary">Kembali</a>
