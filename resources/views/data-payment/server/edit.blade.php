              ...
              <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="form-group mb-2">
                        ...
                        <input type="text" name="netto" class="form-control @error('netto') is-invalid @enderror" value="{{ $data->netto }}">
                        @error('netto')
                        <div class="text-danger">
                            <small>
                                {{ $message }}
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input type="text" name="nospm" class="form-control @error('nospm') is-invalid @enderror" value="{{ $data->nospm }}">
                        @error('nospm')
                        <div class="text-danger">
                            <small>
                                {{ $message }}
                ...
                <div class="col-lg-3">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input type="text" name="tanggal" class="form-control @error('tanggal') is-invalid @enderror" placeholder="dd-mm-yyyy" value="{{ date('d-m-Y',$data->tanggal) }}">
                        @error('tanggal')
                        <div class="text-danger">
                            <small>
                                {{ $message }}
