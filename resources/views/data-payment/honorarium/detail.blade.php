                        ...
                        <tr class="align-middle">
                            ...
                            <td>
                                <form action="/data-payment/honorarium/{{ $item->id }}/detail" method="post">
                                    ...
                                    <a href="/data-payment/honorarium/{{ $item->id }}/upload-detail" data-toggle="tooltip" data-placement="bottom" title="Kirim" onclick="return confirm('Apakah Anda yakin akan mengirim data ini?');"  class="btn btn-sm btn-outline-primary pt-0 pb-0">upload</a>
                                </form>
                            </td>
                        </tr>
                    @endforeach
