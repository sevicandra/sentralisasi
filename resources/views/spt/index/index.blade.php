            ...
            <div class="row">
                <div class="col-lg-12">
                    @foreach ($tahun as $item)
                        <a href="{{ Request::url() }}?thn={{$item->tahun}}" class="btn btn-sm btn-outline-success @if ($item->tahun === request('thn')|| request('thn') === null && $item->tahun - 0 === date('Y') - 1) active @endif ml-1 mt-1 mb-1">{{$item->tahun}}</a>
                    @endforeach
                </div>
                <div class="col-lg-12">
                    <a href="/spt/create" class="btn btn-sm btn-outline-success ml-1 mt-1 mb-1">
                        Tambah
                    </a>

                    <a href="/spt/import" class="btn btn-sm btn-outline-success ml-1 mt-1 mb-1">
                        import
                    </a>
                </div>
            </div>
