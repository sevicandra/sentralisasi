                            ...
                            <tr class="*:border">
                                ...
                                <x-table.body.column class="text-center">
                                    <div class="w-full h-full flex gap-1 justify-center">
                                        <a href="/belanja-51-vertikal/uang-lembur/arsip/{{ $item->id }}"
                                            class="btn btn-xs btn-primary">Detail</a>
                                        <a href="/belanja-51-vertikal/uang-lembur/arsip/{{ $item->id }}/history"
                                            class="btn btn-xs btn-primary">Riwayat</a>
                                        @if ($item->status == 'proses')
                                            <form action="/belanja-51-vertikal/uang-lembur/arsip/{{ $item->id }}/batal"
                                                method="post"
