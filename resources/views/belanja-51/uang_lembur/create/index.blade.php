            ...
            <div>
                <div class="flex gap-1 flex-wrap">
                    @foreach ($tahun as $item)
                        <a href="{{ config('app.url') }}/belanja-51-vertikal/uang-lembur/create/{{ $item }}"
                ...
                <x-table.body>
                    ...
                    <tr class="*:border">
                        ...
                        <x-table.body.column class="text-center">
                            <a href="/belanja-51-vertikal/uang-lembur/create/{{ $thn }}/{{ $item->bulan }}"
                ...
                {{-- <form action="" enctype="multipart/form-data" autocomplete="off">
                    <div class="flex flex-col gap-2 w-full max-w-2xl">
                        ...
                        <div class="flex gap-2 p-2">
                            <a href="/belanja-51-vertikal/uang-lembur" class="btn btn-xs btn-secondary">Kembali</a>
