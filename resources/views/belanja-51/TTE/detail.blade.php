    ...
    <div class="h-full grid grid-rows-[auto_1fr_auto] grid-cols-1 gap-2 relative">
        <div class="flex flex-col gap-2 py-2 px-4">
            <div class="w-full flex gap-1 flex-wrap justify-between">
                ...
                <button type="button" onclick="tte_modal.showModal()"
                    class="btn btn-xs btn-success">kirim</button>
            </div>
        </div>
                ...
                <form action="" method="POST"
                    ...
                    <div class="flex flex-col gap-2 w-full max-w-2xl">
                        <div class="flex flex-col">
                            <div class="flex flex-col">
                                <x-input name="passphrase" type="password"
                                    label="Passphrase:" size="w-full" :required="true" />
                            </div>
                        </div>
                        <div class="flex gap-2 p-2">
                            <button type="submit"
                                class="btn btn-xs btn-success">Proses</button>
                        </div>
                    </div>
                </form>
            </div>
