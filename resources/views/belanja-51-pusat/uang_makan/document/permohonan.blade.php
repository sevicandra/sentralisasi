...
<page backtop="0mm" backbottom="0mm" backleft="0mm" backright="0mm">
    ...
    <p class="paragraph">
        ...
        Permohonan Pembayaran Uang Makan Periode Bulan {{ \Carbon\Carbon::createFromDate(null, $bulan)->translatedFormat('F') }} Tahun {{ $tahun }}, dengan
    ...
    <table class="rekap">
        <tr>
            ...
            <th style="width: 30mm;">Jumlah Hari</th>
        </tr>
        @foreach ($data as $item)
            <tr>
                ...
                <td style="text-align: center">{{ $item->jml }} hari</td>
            </tr>
        @endforeach
    </table>
    <br>
