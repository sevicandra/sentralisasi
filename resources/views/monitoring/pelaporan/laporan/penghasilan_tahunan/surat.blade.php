...
<page backtop="40mm" backbottom="0mm" backleft="5mm" backright="5mm">
        ...
        <table class="page_header" cellspacing="0px" cellpadding="0px">
            <tr>
                <td class="logo" rowspan="10">
                    {{-- <img src="" alt="logo kemenkeu" width="100"> --}}
                </td>
                <td class="kop1">
    ...
    <div id="judul1" style="margin-top: 10px;">
        ...
        <span style="font-size: 12px;">Nomor: </span><span style="font-size: 12px; margin-left: 30px;"></span>
    </div>

    <p style="margin-left:10px; margin-top:25px; text-align: justify;">Yang bertandatangan dibawah ini,  - , menerangkan bahwa:</p>
    ...
    <span style="width: 95%; margin-bottom: 10px; margin-left:10px;">Mempunyai penghasilan bulan <strong></strong> sebagai berikut:</span>
    ...
    <table style="width: 95%; margin-bottom: 10px; margin-left:20px;">
        ...
        <tr>
            <td></td>
            <td style="width: 4%;">2.</td>
            <td style="width: 30%;">Potongan Absen (1%)</td>
            <td style="width: 8%; text-align: right;">Rp</td>
            <td style="width: 12%; text-align: right;"></td>
            <td style="width: 8%; text-align: right;"></td>
            <td style="width: 12%; text-align: right;"></td>
        ...
        <tr>
            ...
            <td style="width: 12%; text-align: right;"><strong></strong></td>
        </tr>
        <tr>
            <td colspan="9" style="width: 94%; font-size:11px; text-align:right;"><i>( rupiah.)</i></td>
        </tr>

        <tr>
            <td colspan="9" style="width: 94%; text-align: justify;">Catatan : Keluarga terdiri atas 1 orang anggota, yaitu 0 istri atau suami dan 0 orang anak yang diperhitungkan untuk menyusun tunjangan keluarga dalam daftar gaji yang bersangkutan.</td>
        </tr>
    </table>
