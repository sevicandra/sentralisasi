...
<page backtop="0mm" backbottom="0mm" backleft="0mm" backright="0mm">
    ...
    <table class="detail">
        <tr>
            <td class="angka" style="width:25%; border-bottom:none; text-align:center;">
                <img src="{{ $src_img }}" alt="logo kemenkeu" width="70">
            </td>
    ...
    <table style="border: 1px solid black; width: 100%;">
        <tr>
            ...
            <td class="kosongatas" style="width:29%; padding-top:3px;">@if ($pegawai->JenisKelamin ==="P") Laki-Laki @else Perempuan @endif </td>
        </tr>
        <tr>
            <td class="kosongatas" style="padding-left:20px;">2. NIP</td>
            <td class="kosongatas">:</td>
            <td class="kosongatas">{{ $pegawai->Nip18 }}</td>
            <td class="kosongatas">7. NIK</td>
            <td class="kosongatas">:</td>
            <td class="kosongatas">{{ $pegawai->Nik }}</td>
        </tr>
        <tr>
            <td class="kosongatas" style="padding-left:20px;">3. NAMA</td>
            <td class="kosongatas">:</td>
            <td class="kosongatas">{{ $pegawai->Nama }}</td>
        ...
        <tr>
            ...
            <td class="kosongatas">:</td>
            <td class="kosongatas">{{ $pegawai->KodeGolonganRuang }}</td>
            <td class="kosongatas"></td>
            <td class="kosongatas">:</td>
        ...
        <tr>
            ...
            <td class="kosongatas" style="width:33%; padding-bottom:3px;">{{ $pegawai->AlamatKtp }}</td>
            ...
            <td class="kosongatas" style="width:29%; padding-bottom:3px;">{{ $pegawai->Jabatan }}</td>
        </tr>
    </table>
