                        ...
                        @foreach ($data as $item)
                            <tr class="*:border">
                                ...
                                <x-table.body.column
                                    ...
                                    <a href="{{ config('app.url') }}/monitoring/laporan/profil/{{ $item->Nip18 }}"
                                        class="btn btn-xs btn-primary" target="_blank">Profil</a>
                                    <a href="{{ config('app.url') }}/monitoring/laporan/pph-pasal-21/{{ $item->Nip18 }}"
                                        class="btn btn-xs btn-primary" target="_blank">PPh Pasal
                                        21</a>
                                    <a href="{{ config('app.url') }}/monitoring/laporan/pph-pasal-21-final/{{ $item->Nip18 }}"
                                        class="btn btn-xs btn-primary" target="_blank">PPh Pasal 21
                                        Final</a>
                                    <a href="{{ config('app.url') }}/monitoring/laporan/penghasilan-tahunan/{{ $item->Nip18 }}"
                                        class="btn btn-xs btn-primary" target="_blank">Penghasilan
                                        Tahunan</a>
                                </x-table.body.column>
                            </tr>
                        @endforeach
