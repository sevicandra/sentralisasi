...
<page backtop="5mm" backbottom="0mm" backleft="5mm" backright="5mm">
    ...
    <table class="detail">
        <tr>
            <td class="angka" style="width:25%; border-bottom:none; text-align:center;">
                {{-- <img src="" alt="logo kemenkeu" width="60"> --}}
            </td>
        ...
        <tr>
            ...
            <td class="angka" style="text-align:center; font-size: 10px; padding-top:5px; padding-bottom:5px;">Nomor : <span>1</span>/1721-VII/2022</td>
        </tr>
    </table>
    ...
    <table style="border: 1px solid black; width: 100%;">
        <tr>
            ...
            <td class="kosong" style="width:50%; margin-bottom:10px; padding-bottom:5px; padding-top:5px;"></td>
            <td class="kosong" style="width:30%;">2. NIP : </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="kosong" style="width:50%; margin-bottom:10px; padding-bottom:10px; padding-top:5px;"></td>
            <td class="kosong" style="width:30%;"></td>
        </tr>
    </table>
    ...
    {{-- <?php $kdgol = substr($peg['kdgol'], 0, 1);?> --}}
    ...
    <table class="detail">
        ...
        <tr style="text-align:center; font-size:7px;">
            ...
            <tr>
                <td class="angka" style="padding-left:15px; border-bottom:none;">
                    <span style="margin-left:12px;">Objek PPh Pasal 21 Final Lainnya</span>
                </td>
        ...
        <tr>
            ...
            <td class="angka" style="padding-right:10px; text-align:right;"><strong></strong></td>
    ...
    <table style="border: 1px solid black; width: 100%;">
        <tr>
            ...
            <td class="kosong" style="width:50%; padding-bottom:10px; padding-top:15px;"></td>
        ...
        <tr>
            ...
            <td class="kosong" style="width:3%; padding-bottom:10px; padding-top:5px;">:</td>
            <td class="kosong" style="width:50%; padding-bottom:10px; padding-top:5px;">BENDAHARA PENGELUARAN </td>
        </tr>
        <tr>
