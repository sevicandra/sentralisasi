                ...
                <x-table class="collapse">
                    ...
                    <x-table.body>
                        <tr class="*:border">
                            ...
                            <x-table.body.column class="text-right">{{ number_format($makan?->pph ? $makan->pph : 0, 0, ',', '.') }}
                            </x-table.body.column>
                        </tr>
                        <tr class="*:border">
                        ...
                        @foreach ($lain as $item)
                            <tr class="*:border">
                                ...
                                <x-table.body.column class="text-right">{{ number_format($item->bruto, 0, ',', '.') }}</x-table.body.column>
                                <x-table.body.column class="text-right">{{ number_format($item->pph, 0, ',', '.') }}</x-table.body.column>
                            </tr>
                            @php
                                $j1 += $item->bruto;
                                $j2 += $item->pph;
