        ...
        <div class="flex flex-col gap-2 flex-wrap py-2 px-4">
            <div class="w-full flex gap-1 flex-wrap">
                @foreach ($tahun as $item)
                    <a href="{{ config('app.url') }}/monitoring/rincian/{{ $nip }}/gaji/{{ $item->tahun }}/{{ $jns }}"
            ...
            <div class="w-full flex gap-1 flex-wrap">
                <a href="{{ config('app.url') }}/monitoring/rincian/{{ $nip }}/gaji/{{ $thn }}/rutin"
                    class="btn btn-xs btn-outline btn-primary @if ($jns === 'rutin' || $jns === null) btn-active @endif">Rutin</a>
                <a href="{{ config('app.url') }}/monitoring/rincian/{{ $nip }}/gaji/{{ $thn }}/kekurangan"
