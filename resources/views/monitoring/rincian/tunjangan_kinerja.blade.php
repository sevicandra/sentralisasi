        ...
        <div class="flex flex-col gap-2 py-2 px-4">
            <div class="w-full flex gap-1 flex-wrap">
                @foreach ($tahun as $item)
                    <a href="{{ config('app.url') }}/monitoring/rincian/{{ $nip }}/tunjangan-kinerja/{{ $item->tahun }}/{{ $jns }}"
            ...
            <div class="w-full flex gap-1 flex-wrap">
                <a href="{{ config('app.url') }}/monitoring/rincian/{{ $nip }}/tunjangan-kinerja/{{ $thn }}/rutin"
                    class="btn btn-xs btn-outline btn-primary @if ($jns === 'rutin' || $jns === null) btn-active @endif">Rutin</a>
                <a href="{{ config('app.url') }}/monitoring/rincian/{{ $nip }}/tunjangan-kinerja/{{ $thn }}/kekurangan"
                    ...
                    <x-table.body>
                        @foreach ($data as $item)
                            <tr class="*:border">
                                ...
                                <x-table.body.column class="text-center">{{ $item->grade }}</x-table.body.column>
                                <x-table.body.column
